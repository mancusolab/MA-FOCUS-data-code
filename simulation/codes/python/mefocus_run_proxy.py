...
def main(args):
    ...
    argp.add_argument("--rho_tissue", default=0.3, type=float, help="Correlation in weights across tissue types")
    argp.add_argument("--proxy_tissue_pop", choices=["pop1", "pop2", "both"], help="Which population(s) is missing the causal tissue and is therefore using a proxy tissue?")
    ...
    if args.proxy_tissue_pop=="pop1":
        eqtl_pop1, coef_pop1, LD_qtl_pop1 = sim_eqtl_proxy(L_pop1, args.nqtl_pop1, b_qtls_pop1, args.rho_tissue, args.eqtl_h2)
        eqtl_pop2, coef_pop2, LD_qtl_pop2 = sim_eqtl(L_pop2, args.nqtl_pop2, b_qtls_pop2, args.eqtl_h2)
    elif args.proxy_tissue_pop=="pop2":
        eqtl_pop1, coef_pop1, LD_qtl_pop1 = sim_eqtl(L_pop1, args.nqtl_pop1, b_qtls_pop1, args.eqtl_h2)
        eqtl_pop2, coef_pop2, LD_qtl_pop2 = sim_eqtl_proxy(L_pop2, args.nqtl_pop2, b_qtls_pop2, args.rho_tissue, args.eqtl_h2)
    elif args.proxy_tissue=="both":
        eqtl_pop1, coef_pop1, LD_qtl_pop1 = sim_eqtl_proxy(L_pop1, args.nqtl_pop1, b_qtls_pop1, args.rho_tissue, args.eqtl_h2)
        eqtl_pop2, coef_pop2, LD_qtl_pop2 = sim_eqtl_proxy(L_pop2, args.nqtl_pop2, b_qtls_pop2, args.rho_tissue, args.eqtl_h2)
    ...
    output = pd.DataFrame({"sim": args.sim,
                           ...
                           "nge2": args.nqtl_pop2,
                           "rho": args.rho_tissue,
                           "proxy_tissue_pop": args.proxy_tissue_pop,
