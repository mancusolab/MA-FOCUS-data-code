...
def main(args):
    ...
    LD_pop1, L_pop1, LDSCs_pop1, bim_1, maf_1, p_pop1, mu1, LD_pop2, L_pop2, LDSCs_pop2, bim_2, maf_2, p_pop2, mu2 = gen_ld(args.prefix_pop1, args.prefix_pop2)
    ...
    gwas_pop1, alpha_pop1 = sim_gwas(L_pop1, args.ngwas_pop1, b_qtls_pop1, args.var_explained, mu1)
    gwas_pop2, alpha_pop2 = sim_gwas(L_pop2, args.ngwas_pop2, b_qtls_pop2, args.var_explained, mu2, alpha = alpha_pop1)
    ...
    eqtl_pop1, coef_pop1, LD_qtl_pop1 = sim_eqtl(L_pop1, args.nqtl_pop1, b_qtls_pop1, args.eqtl_h2, mu1)
    eqtl_pop2, coef_pop2, LD_qtl_pop2 = sim_eqtl(L_pop2, args.nqtl_pop2, b_qtls_pop2, args.eqtl_h2, mu2)
    ...
    score_pop1, within_var_pop1 = compute_twas(gwas_pop1, coef_pop1, LD_pop1)
    score_pop2, within_var_pop2 = compute_twas(gwas_pop2, coef_pop2, LD_pop2)
    score_meta, within_var_meta = compute_twas(gwas_meta, coef_pop1, LD_pop1)
    ...
    for idx in range(args.ngenes - 1):
        ...
        eqtl_pop1, coef_pop1, _ = sim_eqtl(L_pop1, args.nqtl_pop1, b_qtls_pop1, args.eqtl_h2, mu1, return_ld = False)
        eqtl_pop2, coef_pop2, _ = sim_eqtl(L_pop2, args.nqtl_pop2, b_qtls_pop2, args.eqtl_h2, mu2, return_ld = False)
