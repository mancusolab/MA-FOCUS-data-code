...
ps7 <- ggarrange(pipH2GE, gsH2GE, ftH2GE, nrow = 3, labels = c("A", "B", "C"),
    font.label = list(size = arrange_label_size),
    common.legend = TRUE, legend = "bottom")

ggsave("figure-s7.png", plot = ps7, path = "./plot/", height = three_row_height, width = onehalf_col)
...
ps6 <- ggarrange(pipH2G, gsH2G, ftH2G, nrow = 1,labels = c("A", "B", "C"),
    font.label = list(size = arrange_label_size),
    common.legend = TRUE, legend = "bottom")
...
ps4 <- ggarrange(pipCP, gsCP, ftCP, nrow = 1,labels = c("A", "B", "C"),
    font.label = list(size = arrange_label_size),
    common.legend = TRUE, legend = "bottom")
...
ps5 <- ggarrange(pip3POPN1, gs3POPN1, ft3POPN1, nrow = 1,labels = c("A", "B", "C"),
    font.label = list(size = arrange_label_size),
    common.legend = TRUE, legend = "bottom")

ggsave("figure-s5.png", plot = ps5, path = "./plot/", height = one_row_height, width = two_col)
...
ps9 <- ggarrange(pipREAL2, gsREAL2, ftREAL2, nrow = 3, labels = c("A", "B", "C"),
    font.label = list(size = arrange_label_size),
    common.legend = TRUE, legend = "bottom")

ggsave("figure-s9.png", plot = ps9, path = "./plot/", height = three_row_height, width = two_col)
...
p3 <- pipH2GE2
ggsave("figure-m3.pdf", plot = p3, path = "./plot/", height = one_row_height, width = two_col, dpi = 300)
...
ps8 <- ggarrange(gsH2GE2, ftH2GE2, nrow = 2, labels = c("A", "B"),
    common.legend = TRUE, legend = "bottom")

ggsave("figure-s8.png", plot = ps8, path = "./plot/", height = two_row_height, width = two_col)
